...
<html>
<head>
	<title>Cadastro Andamento</title>
	<meta charset="utf-8">
...
<body>
	...
	<div align="CENTER">
			...
			<p>Cadastro de Andamento</p>
<!--######################### inicio do form e div o qual o contem ##########################-->
		<div class="container">
			<div class="alert alert-info ">
				<form name="formContato" method="get" action="cadastraand.php">
					<p>
					...
					<p>
					<input class="btn btn-primary" type="submit" name="button" id="button" value="Selecionar">
					</p>
				</form>
			</div>
		</div>
