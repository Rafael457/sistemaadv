	...
	<div class="container">
		...
		<div align="left">
			<div class="alert alert-info">		
				<form name="formContato" method="get" action="alterarandamento.php">
					<div class="row">
						<div class="col-lg-3">
							<p>
							Nº do processo:
							...
							<input type="hidden" name="numeroand" id="numeroand" value="<?=$numeroand?>">
							</p>		
						</div>
						<div class="col-lg-3">
							<p>
							...
							<p>
							<input type="text" name="nomecli" id="nomecli" value="<?=$nomecli?>" disabled>
						...
						<div class="col-lg-3">
							...
							<p>
							<input type="text" name="nomeemp" id="nomeemp" value="<?=$nomeemp?>" disabled>
					...
					<div class="row">
						<div class="col-lg-3">
							...
							<p>
							<input type="date" class="btn btn-primary" name="dataaud" value="<?=$dataaud?>">
							</p>		
						</div>
						<div class="col-lg-3">
							<p>
							...
							<p>
							<input type="time" class="btn btn-primary" name="horaaud" value="<?=$horaaud?>">
							</p>
						</div>
					</div>
					<div align="center">
					...
					<p>
						<textarea name="assuntos" id="end" cols="100" rows="5"><?=$assunto?></textarea>
					</p>
					</div>
					<p>
						<input type="submit" class="btn btn-primary" name="button" id="button" value="Alterar Andamento">
					</p>
				</form>
			</div>
		</div>
